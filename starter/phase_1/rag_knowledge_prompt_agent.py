...
# Step 1: Chunk the knowledge text into manageable pieces
chunks = RAG_knowledge_prompt_agent.chunk_text(knowledge_text)

# Step 2: Compute embeddings for each chunk and store them
embeddings = RAG_knowledge_prompt_agent.calculate_embeddings()

# Step 3: Query the agent using RAG-based retrieval
prompt = "What is the podcast that Clara hosts about?"
print(f"Prompt: {prompt}")
print(RAG_knowledge_prompt_agent.find_prompt_in_knowledge(prompt))
