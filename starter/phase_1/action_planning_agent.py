...
# Instantiate the ActionPlanningAgent with the knowledge base and API key
action_agent = ActionPlanningAgent(openai_api_key, knowledge)

# Extract and print the action steps for making scrambled eggs
steps = action_agent.extract_steps_from_prompt("One morning I wanted to have scrambled eggs")
print("Action steps extracted by the ActionPlanningAgent:")
for step in steps:
    print(step)
